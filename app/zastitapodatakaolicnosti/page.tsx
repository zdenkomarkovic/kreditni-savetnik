    ...
    <div className="py-24">
      <div className="container px-2 md:px-4 mx-auto">
        ...
        <p>
          ...
          opredelio, kako bi nastavio direktnu komunikaciju, na zakonom
          dozvoljen način, a u srazmeri sa svrhom obrade. Podaci se prikupljaju
          od Korisnika prilikom njihove registracije na Servisu. Vrste podataka
        ...
        <p>
          ...
          identifikaciju lica koja biraju informativne ponude banaka u vezi sa
          finansijskim proizvodima, a u skladu sa dobrim poslovnim običajima,
        ...
        <p>
          ...
          može u bilo koje doba i bez obrazloženja povući svoj pristanak.
        </p>
        <p>
          5. Da u slučaju nedozvoljene obrade, lica imaju prava na zaštitu
          podataka o ličnosti, kao i drugih prava koja im po zakonu pripadaju i
        ...
        <p>
          ...
          obaveznu procenu kreditne sposobnosti (status zaposlenja, visina
          mesečnih primanja i naziv banke kod koje se vrši priliv tih primanja,
          postojanje mesečnih zaduženja, ukupan staž i staž kod poslednjeg
